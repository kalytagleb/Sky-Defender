...
import objects.weapon.strategy.check.OutOfBoundsAttempt;
import objects.weapon.strategy.damage.SimpleDamage;
import objects.weapon.strategy.draw.CircleDrawStrategy;
 ...
 * </ul>
 */
public class Rocket extends AbstractWeapon implements Weapon {
